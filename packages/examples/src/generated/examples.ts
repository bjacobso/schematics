...
export const schemaIdeExampleDefinitions = [
  {
    ...
    name: "Document Conversion Artifacts",
    description:
      "HTML source files declare generated Markdown, PDF, and PDF field metadata artifacts.",
    schema: DocumentConversionWorkspaceSchema,
    defaultFormat: "json",
    suggestedPrompts: [
      "Show the artifact dependency graph",
      "Which generated outputs are missing or blocked?",
    ],
    directory: "document-conversion",
    filesPath: "workspaces/document-conversion/files",
    configPath: "workspaces/document-conversion/schema-ide.config.ts",
  },
  {
...
export const schemaIdeExamples = [
  {
    ...
    files: [
      {
        path: "documents/safety.json",
        content:
          '{\n  "id": "safety",\n  "title": "Safety Policy",\n  "collection": "policies",\n  "document": "safety",\n  "sourcePath": "sources/policies/safety/index.html",\n  "outputs": {\n    "markdownPath": "generated/policies/safety/document.md",\n    "pdfPath": "generated/policies/safety/document.pdf",\n    "fieldMetadataPath": "generated/policies/safety/pdf-fields.json"\n  }\n}\n',
      },
      {
        path: "sources/policies/safety/index.html",
        content:
          '<!doctype html>\n<html>\n  <head>\n    <title>Safety Policy</title>\n  </head>\n  <body>\n    <main>\n      <h1>Safety Policy</h1>\n      <p>Visitors must check in before entering the production floor.</p>\n      <label>\n        Supervisor approval\n        <input name="supervisorApproval" type="checkbox" />\n      </label>\n    </main>\n  </body>\n</html>\n',
      },
      {
        path: "generated/policies/safety/document.md",
        content:
          "# Safety Policy\n\nVisitors must check in before entering the production floor.\n\n- Field: `supervisorApproval`\n- Type: checkbox\n",
      },
      {
        path: "generated/policies/safety/document.pdf",
        content:
          "JVBERi0xLjQKMSAwIG9iago8PCAvVHlwZSAvQ2F0YWxvZyAvUGFnZXMgMiAwIFIgPj4KZW5kb2JqCjIgMCBvYmoKPDwgL1R5cGUgL1BhZ2VzIC9Db3VudCAwID4+CmVuZG9iagp0cmFpbGVyCjw8IC9Sb290IDEgMCBSID4+CiUlRU9GCg==",
      },
      {
        path: "generated/policies/safety/pdf-fields.json",
        content:
